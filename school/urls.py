...
urlpatterns = [
    ...
    path("all_athletesreport/", all_athletesReports, name="all_athletesreport"),
    path("officialsreport/", officialsReports, name="officialsreport"),
    path("all_officialsReports/", all_officialsReports, name="all_officialsreports"),
    path("positionsreport/", positionsReports, name="positionsreport"),
    path("merit_reports/", meritReports, name="meritReports"),
    ...
    path("allpositions/", allPositions, name="allpositions"),
    # path("export_ocsv/", export_ocsv, name="export_ocsv"),
